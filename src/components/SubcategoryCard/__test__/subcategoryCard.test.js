...
it('renders without crashing', ()=>{
    ...
    ReactDOM.render(<BrowserRouter><SubcategoryCard category={category1} subcategory={subcategory1}/></BrowserRouter>,div)
})

it('renders href and image correctly', ()=>{
   const {getByTestId} = render(<BrowserRouter><SubcategoryCard category={category1} subcategory={subcategory1}/></BrowserRouter>)
...
it('matches snapshot', ()=>{
    const tree = renderer.create(<BrowserRouter><SubcategoryCard category={category1} subcategory={subcategory1}/></BrowserRouter>).toJSON();
